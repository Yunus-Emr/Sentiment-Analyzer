...
st.set_page_config(page_title="Duygu Analizi", page_icon="🧠", layout="centered")

st.title("🧠 Türkçe Duygu Analizi Uygulaması")
st.markdown("""
Bu uygulama, yazdığınız Türkçe cümlelerdeki duyguyu tahmin eder.  
Lojistik Regresyon modeli ve CountVectorizer ile eğitilmiştir.
""")

st.markdown("---")

with open('model/emotion_model.pkl', 'rb') as model_file:
...
user_input = st.text_area("✍️ Bir cümle yazın ve duygusunu tahmin edelim:", height=150)
